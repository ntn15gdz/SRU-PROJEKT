	...
	public INFOSRU() throws IOException {
		...
		btnSkicka.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String text = nyinfo.skapaInfoSRU(textF1_2.getText(), textF1_4.getText(), textF1_5.getText(),
						textF1_12.getText(), textF1_6.getText(), textF1_7.getText(), textF1_10.getText(),
						textF1_11.getText(), textF1_13.getText(), textF1_14.getText(), textF1_15.getText(),
						textF1_16.getText(), textF1_17.getText(), textF1_18.getText(), textF1_19.getText());

				try {
					srudao.printToFile("info.sru", text);

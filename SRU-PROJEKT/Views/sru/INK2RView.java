...
public class INK2RView extends JPanel {
	 ...
	 */
	public INK2RView() {
		setLayout(new MigLayout("", "[400.00px][6px][699px][6px]", "[15px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][15px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px][20px]"));
		
		label2_1_12 = new JLabel("<html>Tillg\u00E5ngar/Anl\u00E4ggningstillg\u00E5ngar</html> ");
		label2_1_12.setFont(new Font("Tahoma", Font.BOLD, 12));
		add(label2_1_12, "cell 0 0,alignx left,aligny top");
		
		JLabel titel2_27_28 = new JLabel("Egen Kapital");
		titel2_27_28.setFont(new Font("Tahoma", Font.BOLD, 12));
		add(titel2_27_28, "cell 2 0,alignx left,aligny top");
		
		JLabel label2_1 = new JLabel("<html>2.1 Immateriella anl\u00E4ggningstillg\u00E5ngar  Koncessioner, patent, licenser,       varum\u00E4rken, hyresr\u00E4tter, goodwill        och liknande r\u00E4ttigheter</html>");
		add(label2_1, "cell 0 1,aligny center");
		
		textField2_1 = new UppgiftField("7201");
		add(textField2_1, "cell 1 1,growx,aligny top");
		textField2_1.setColumns(10);
		
		JLabel label2_27 = new JLabel("2.27 Bundet eget kapital");
		add(label2_27, "cell 2 1,alignx left,aligny center");
		
		textField2_27 = new UppgiftField("7301");
		add(textField2_27, "cell 3 1,growx,aligny top");
		textField2_27.setColumns(10);
		
		JLabel label2_2 = new JLabel("2.2 F\u00F6rskott avseende immateriella        anl\u00E4ggningstillg\u00E5ngar");
		add(label2_2, "cell 0 2,alignx left,aligny center");
		
		textField2_2 = new UppgiftField("7202");
		add(textField2_2, "cell 1 2,growx,aligny top");
		textField2_2.setColumns(10);
		
		JLabel label2_28 = new JLabel("2.28 Fritt eget kapital");
		add(label2_28, "cell 2 2,alignx left,aligny center");
		
		textField2_28 = new UppgiftField("7302");
		add(textField2_28, "cell 3 2,growx,aligny top");
		textField2_28.setColumns(10);
		
		JLabel lablel2_3 = new JLabel("Materiella anl\u00E4ggningstillg\u00E5ngar 2.3 Byggnader och mark");
		add(lablel2_3, "cell 0 3,alignx left,aligny center");
		
		textField2_3 = new UppgiftField("7214");
		add(textField2_3, "cell 1 3,growx,aligny top");
